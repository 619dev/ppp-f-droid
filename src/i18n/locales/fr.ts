export const fr: Record<string, string> = {
  ...
  "chat.presentation_title": "Chiffrement local supplémentaire",
  'profile.message_privacy': 'Confidentialité des messages',
  'profile.message_privacy_desc': 'Ces réglages s’appliquent à toutes les conversations de cet appareil. Les métadonnées brutes du protocole sont masquées par l’apparence choisie.',
