export const es: Record<string, string> = {
  ...
  "chat.presentation_title": "Cifrado local adicional",
  'profile.message_privacy': 'Privacidad de los mensajes',
  'profile.message_privacy_desc': 'Estos ajustes se aplican globalmente a todos los chats de este dispositivo. La apariencia elegida oculta los metadatos originales del protocolo.',
